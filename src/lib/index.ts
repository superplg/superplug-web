...
import IngButtonGray from "./ingolstadt/IngButtonGray.wc.svelte";
...
import IngForm from "./ingolstadt/IngForm.wc.svelte";
...
import ElegantBuffetView from "./mountainview/ElegantBuffetView.wc.svelte";
import ElegantBuffetEdit from "./mountainview/ElegantBuffetEdit.wc.svelte";
import ElegantLanding from "./mountainview/ElegantLanding.wc.svelte";
...
// new is the best one - import GenEditor from "./geneva/GenEditorNew.wc.svelte";
// import GenEditor from "./geneva/GenEditor.wc.svelte";

export { IngButton, IngButtonGray, IngHeaderLite, IngBuffet, IngInput, IngTable, IngSelect, IngForm, ElegantHeader, ElegantBuffet, ElegantBuffetView, ElegantBuffetEdit, ElegantLanding, ElegantHeroSearch, ElegantSearch, ElegantTable, ElegantSpinner };